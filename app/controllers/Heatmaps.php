...
class Heatmaps extends Controller {
    ...
    public function index() {
        ...
        /* Delete Modal */
        $view = new \Altum\View('heatmap/heatmap_delete_modal', (array) $this);
        \Altum\Event::add_content($view->run(), 'modals');
        ...
        $paginator = (new \Altum\Paginator($total_heatmaps, settings()->main->default_results_per_page, $_GET['page'] ?? 1, url('heatmaps?page=%d')));
