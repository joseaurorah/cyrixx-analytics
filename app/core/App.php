    ...
    public function __construct() {
        ...
        if(\Altum\Authentication::check()) {
            ...
            if(
                ...
                && !in_array(\Altum\Router::$controller_key, ['index', 'affiliate', 'contact', 'page', 'pages', 'plan', 'pay', 'pay-billing', 'pay-thank-you', 'account', 'account-plan', 'account-payments', 'invoice', 'account-logs', 'account-delete', 'referrals', 'account-api', 'account-redeem-code', 'logout', 'register', 'teams-system', 'teams-member', 'teams-members', 'teams', 'team', 'teams-ajax', 'teams-associations-ajax', 'register'])
