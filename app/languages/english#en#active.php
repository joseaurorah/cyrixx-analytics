...
return [
    ...
    'domain_update.breadcrumb' => 'Edit Edit custom domain',
    'domain_update.title' => 'Edit Edit custom domain',
    'domain_update.menu' => 'Edit Edit custom domain',
    ...
    'help.custom_parameters.p5' => 'If that extra parameter is provided then, in the Visitors page you will see the <i class="fa fa-fw fa-fingerprint text-primary"></i> icon near the visitor which tells you that that specific user has been identified with custom parameters.',
    ...
    'dashboard.countries.country' => 'Country',

    'dashboard.cities.header' => 'Cities',
    'dashboard.cities.city' => 'City',
    ...
    'realtime.header' => 'Realtime analytics for %s',
    ...
    'visitors.header.header' => 'Visitors of %s',
    ...
    'visitor.visitor.country' => 'Country',
    'visitor.visitor.city' => 'City',
    ...
    'heatmaps.heatmap.is_enabled' => 'Status',
    ...
    'website_create_modal.header' => 'Add New Website',
    ...
    'index.meta_keywords' => '',
    'index.header' => 'Comprehensive Web Analytics.',
    'index.subheader' => 'Simple and friendly analytics. Replay sessions, collect heatmaps, track user journeys, and much more.',
    'index.sign_up' => 'Get started',
    'index.breadcrumb' => 'Home',

    'index.analytics.name' => 'Analytics',
    'index.analytics.header' => 'Excellent and appealing analytics',
    'index.analytics.subheader' => 'Have you ever been overwhelmed by the amount of information in front of you and unsure of its meaning? We are offering you an intuitive UI that is clear and uncomplicated, together with metrics that are straightforward to comprehend.',

    'index.visitor_behaviour.name' => 'Visitor behaviour',
    'index.visitor_behaviour.header' => 'Recognise your audience',
    'index.visitor_behaviour.subheader' => 'The secret to improving your website is to understand your consumers. Verify every visitor\'s route and actions on your website without violating their privacy.',

    'index.realtime_data.name' => 'Realtime data',
    'index.realtime_data.header' => 'Visitor analytics in real-time',
    'index.realtime_data.subheader' => 'Do you want to view data in real time? You can see the number of users that are online, the most popular devices, and the most viewed pages.',

    'index.privacy.name' => 'Privacy',
    'index.privacy.header' => 'Your data is owned by you and is never sold!',
    'index.privacy.subheader' => 'If Google Analytics is accessible, why would you want to pay more for a service like this? Your data is important to us, so we never sell it to third parties and give you complete control over it. It\'s always possible to remove!',

    'index.session_recording.name' => 'Session recording',
    'index.session_recording.header' => 'Record & replay visitors sessions',
    'index.session_recording.subheader' => 'This is only the greatest technique to see how a person navigates your website. What they connect with, their destination, and the things they enjoy and find confusing. Replaying their meetings is a simple way to see exactly what they accomplished.',

    'index.heatmaps.name' => 'Heatmaps',
    'index.heatmaps.header' => 'Heatmaps tracking',
    'index.heatmaps.subheader' => 'Heatmaps are an incredibly user-friendly approach to testing out pages on your website and determining which sections are the most popular with a group of users.',

    'index.testimonials.header' => 'What other people are saying',
    'index.testimonials.subheader' => 'Reviews from customers that have utilised our product.',

    'index.testimonials.t1.image' => 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=144&h=144&q=80',
    'index.testimonials.t1.text' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent finibus vestibulum porta. Sed id eros quam. Nunc at nisi vel arcu placerat gravida. Proin lacinia ipsum porttitor, sollicitudin est in, ornare ex. Vivamus eu ex non orci condimentum placerat ac ac nisi. Nam velit libero, hendrerit vitae auctor eget, congue ut ante.',
    'index.testimonials.t1.name' => 'George',
    'index.testimonials.t1.attribute' => 'Founder of X Machine',

    'index.testimonials.t2.image' => 'https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=144&h=144&q=80',
    'index.testimonials.t2.text' => 'Praesent finibus vestibulum porta. Sed id eros quam. Proin lacinia ipsum porttitor, sollicitudin est in, ornare ex. Vivamus eu ex non orci condimentum placerat ac ac nisi. Nam velit libero, hendrerit vitae auctor eget, congue ut ante.',
    'index.testimonials.t2.name' => 'Calvin',
    'index.testimonials.t2.attribute' => 'Owner X Website',

    'index.testimonials.t3.image' => 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=144&h=144&q=80',
    'index.testimonials.t3.text' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.Ornare ex. Vivamus eu ex non orci condimentum placerat ac ac nisi. Nam velit libero, hendrerit vitae auctor eget, congue ut ante.',
    'index.testimonials.t3.name' => 'Andrea',
    'index.testimonials.t3.attribute' => 'Writter at X Magazine',
    ...
    'api_documentation.websites.scheme' => 'Allowed values are: <code>http://</code> and <code>https://</code>.',
    'api_documentation.websites.host' => 'Website Host & Path. Example: <code>https://example.com/path</code>.',
    'api_documentation.websites.tracking_type' => 'Allowed values are: <code>lightweight</code> and <code>normal</code>.',
