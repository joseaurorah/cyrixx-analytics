...
return [
    ...
    'admin_plans.plan.sessions_events_limit' => 'Pageviews limit',
    'admin_plans.plan.events_children_limit' => 'Visitors Events limit',
    'admin_plans.plan.events_children_limit_help' => 'Tracking of the behaviour of the users on the website such as (clicks, resizes, form submissions..etc). Set to 0 to disable the feature, set -1 for unlimited.',
    'admin_plans.plan.events_children_retention' => 'Visitors Events Data Retention',
    'admin_plans.plan.events_children_retention_help' => 'How many days will the data be kept in the database.',
    'admin_plans.plan.sessions_replays_limit' => 'Session Replays Total limit',
    'admin_plans.plan.sessions_replays_limit_help' => 'Full and advanced Tracking of the behaviour of the users on the website and the ability to replay those actions. Set to 0 to disable the feature, set -1 for unlimited.',
    'admin_plans.plan.sessions_replays_retention' => 'Session Replays Data Retention',
    'admin_plans.plan.sessions_replays_retention_help' => 'How many days will the data be kept in the database.',
    'admin_plans.plan.sessions_replays_time_limit' => 'Session Replays Time limit',
    'admin_plans.plan.sessions_replays_time_limit_help' => 'The maximum amount of minutes the session replay will record events for.',
    'admin_plans.plan.websites_heatmaps_limit' => 'Websites Heatmaps limit',
    'admin_plans.plan.websites_heatmaps_limit_help' => 'How many heatmaps can the user create. Set to 0 to disable the feature, set -1 for unlimited.',
    'admin_plans.plan.websites_goals_limit' => 'Goals tracking limit',
    'admin_plans.plan.websites_goals_limit_help' => 'Gives the user the ability to track their website goals with the Goals functionality. Set to 0 to disable the feature, set -1 for unlimited.',
    ...
    'admin_plans.plan.email_reports_is_enabled_help' => 'Enabling this will give all people having this plan the ability to enable email reports for their websites.',
    'admin_plans.plan.teams_is_enabled' => 'Teams system',
    'admin_plans.plan.teams_is_enabled_help' => 'Enabling this will give all people having this plan the ability to use the Teams system to create and invite people to their teams.',
    ...
    'admin_index.teams' => 'Teams',
    'admin_index.heatmaps' => 'Heatmaps',
    'admin_index.goals' => 'Goals',
    'admin_index.email_reports' => 'Email reports',
    ...
    'admin_settings.documentation' => 'Read the <a href="https://altumco.de/66analytics-docs" target="_blank">Documentation</a> to get more details on certain available configurations.',
    ...
    'admin_settings.analytics.tab' => 'Analytics',
    'admin_settings.analytics.sessions_replays_is_enabled' => 'Enable Sessions Replays (BETA)',
    'admin_settings.analytics.sessions_replays_is_enabled_help' => 'Sessions Replays is a more advanced tracking system which tries to track almost everything a user does on a page and visually replay that session to the owner of the site.',
    'admin_settings.analytics.sessions_replays_is_enabled_help2' => 'This feature can be activated but must be carefully used as it may still contain bugs.',
    'admin_settings.analytics.sessions_replays_is_enabled_help3' => 'In certain cases, if the website that is tracked is large and your webhost doesn\'t allow to post a big amount of data then it could not work properly. Your current POST_MAX_SIZE is: %s.',
    'admin_settings.analytics.sessions_replays_minimum_duration' => 'Minimum duration of a session replay (in seconds)',
    'admin_settings.analytics.sessions_replays_minimum_duration_help' => 'The Cronjob will automatically delete all the sessions replays which do not meet the required duration.',
    'admin_settings.analytics.sessions_replays_minimum_duration_help2' => 'The cron will only delete the replays after 24 hours of user inactivity to make sure the session is not active anymore.',
    'admin_settings.analytics.websites_heatmaps_is_enabled' => 'Enable Heatmaps (BETA)',
    'admin_settings.analytics.websites_heatmaps_is_enabled_help' => 'Heatmaps give the user the ability to track specific pages and look for the most used parts of those pages based on data from multiple people.',
    'admin_settings.analytics.pixel_cache' => 'Pixel Cache (in seconds)',
    'admin_settings.analytics.pixel_cache_help' => 'Set 0 to disable the cache of the pixel tracking code.',
    'admin_settings.analytics.pixel_exposed_identifier' => 'Pixel exposed identifier',
    'admin_settings.analytics.pixel_exposed_identifier_help' => 'The pixel key is used when telling your users how to customly use your tracking code. An example would be for tracking their goals: <code><strong>your_pixel_exposed_identifier</strong>.goal(\'my-goal\');</code>.',
    'admin_settings.analytics.email_reports_is_enabled' => 'Email Reports system for analytics',
    'admin_settings.analytics.email_reports_is_enabled_weekly' => 'Weekly',
    'admin_settings.analytics.email_reports_is_enabled_monthly' => 'Monthly',
    'admin_settings.analytics.email_reports_is_enabled_help' => 'Enabling the email reports will give your users the ability to get email reports of their website statistics. Make sure to have a proper email sending configuration via the SMTP tab.',
    'admin_settings.analytics.domains_is_enabled' => 'Enable the Custom Domains system',
    'admin_settings.analytics.domains_is_enabled_help' => 'Enabling this will give your users the ability to add and use custom domains.',
    'admin_settings.analytics.blacklisted_domains' => 'Blacklisted domains',
    'admin_settings.analytics.blacklisted_domains_help' => 'People will not be able to submit any URL domain that is included in this list. Comma separated values of domains.',
    ...
    'admin_statistics.websites.menu' => 'Websites',
    'admin_statistics.websites.header' => 'Websites',
    'admin_statistics.websites.chart' => 'New websites',

    'admin_statistics.lightweight_events.menu' => 'Lightweight pageviews',
    'admin_statistics.lightweight_events.header' => 'Lightweight pageviews',
    'admin_statistics.lightweight_events.chart' => 'Lightweight pageviews',

    'admin_statistics.sessions_events.menu' => 'Pageviews',
    'admin_statistics.sessions_events.header' => 'Pageviews',
    'admin_statistics.sessions_events.chart' => 'Pageviews',

    'admin_statistics.events_children.menu' => 'Visitors events',
    'admin_statistics.events_children.header' => 'Visitors events',
    'admin_statistics.events_children.chart_click' => 'Clicks',
    'admin_statistics.events_children.chart_form' => 'Form submissions',
    'admin_statistics.events_children.chart_scroll' => 'Scroll Events',
    'admin_statistics.events_children.chart_resize' => 'Window resize events',

    'admin_statistics.sessions_replays.menu' => 'Sessions replays',
    'admin_statistics.sessions_replays.header' => 'Sessions replays',
    'admin_statistics.sessions_replays.chart' => 'Sessions replays',

    'admin_statistics.websites_heatmaps.menu' => 'Heatmaps',
    'admin_statistics.websites_heatmaps.header' => 'Heatmaps',
    'admin_statistics.websites_heatmaps.chart' => 'Heatmaps',

    'admin_statistics.websites_goals.menu' => 'Goals',
    'admin_statistics.websites_goals.header' => 'Goals',
    'admin_statistics.websites_goals.chart' => 'Goals',

    'admin_statistics.goals_conversions.menu' => 'Goals conversions',
    'admin_statistics.goals_conversions.header' => 'Goals conversions',
    'admin_statistics.goals_conversions.chart' => 'Goals conversions',

    'admin_statistics.teams.menu' => 'Teams',
    'admin_statistics.teams.header' => 'Teams',
    'admin_statistics.teams.chart' => 'New teams',

    'admin_statistics.email_reports.menu' => 'Email reports',
    'admin_statistics.email_reports.header' => 'Email Reports',
    'admin_statistics.email_reports.subheader' => 'How many email reports are sent out per day to your users.',
    ...
    'admin_websites.title' => 'Websites management',
    'admin_websites.header' => 'Websites management',
    'admin_websites.menu' => 'Websites',

    'admin_websites.table.user' => 'User',
    'admin_websites.table.website' => 'Website',
    'admin_websites.table.usage' => 'Usage this month',
    'admin_websites.table.is_enabled' => 'Status',
    'admin_websites.table.name' => 'Name',
    'admin_websites.table.host' => 'Domain',

    'admin_websites.filters.tracking_type' => 'Tracking type',
    'admin_websites.filters.tracking_type_normal' => 'Advanced',
    'admin_websites.filters.tracking_type_lightweight' => 'Lightweight',
];
