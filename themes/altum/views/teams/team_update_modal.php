    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><?= l('team_update_modal.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="team_update" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-sm fa-fw fa-signature text-muted mr-1"></i> <?= l('team_update_modal.input.name') ?></label>
                        <input type="text" class="form-control form-control-lg" name="name" required="required" />
                    </div>

                    <div class="form-group">
                        <label><?= l('team_update_modal.input.websites_ids') ?></label>
                        ...
                        <small class="form-text text-muted"><?= l('team_update_modal.input.websites_ids_help') ?></small>
                    </div>
