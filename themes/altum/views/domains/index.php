    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('domain-create') ?>" class="btn btn-outline-primary"><i class="fa fa-fw fa-sm fa-plus"></i> <?= l('domains.create') ?></a>
                <?php endif ?>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <?php if($row->is_enabled): ?>
                                <span class="badge badge-success"><i class="fa fa-fw fa-check"></i> <?= l('domains.table.is_enabled_active') ?></span>
                            <?php else: ?>
                                <span class="badge badge-warning"><i class="fa fa-fw fa-eye-slash"></i> <?= l('domains.table.is_enabled_pending') ?></span>
                            <?php endif ?>
                        </td>
