    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-10 col-sm-8 col-xl-6">
                <p class="index-subheader text-center text-muted mb-4"><?= l('index.subheader') ?></p>
            </div>
        </div>

        <div class="text-center">
            <a href="<?= url('register') ?>" class="btn btn-primary btn-lg"><?= l('index.sign_up') ?></a>
        </div>
    </div>
...
<div class="container mt-10">
    ...
    <div class="row justify-content-between">
        <div class="col-12 col-md-6 d-flex flex-column justify-content-center order-1 order-md-0">
            <div class="text-uppercase font-weight-bold text-primary mb-3"><?= l('index.analytics.name') ?></div>

            <div>
                <h2 class="mb-4"><?= l('index.analytics.header') ?></h2>
    ...
    <div class="row justify-content-between mt-9">
        <div class="col-12 col-md-6 d-flex flex-column justify-content-center order-1 order-md-0">
            ...
            <div>
                ...
                <p class="text-muted"><?= l('index.realtime_data.subheader') ?></p>
            </div>
        </div>
    ...
    <div class="row justify-content-between mt-9">
        ...
        <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
            <div class="text-uppercase font-weight-bold text-primary mb-3"><?= l('index.privacy.name') ?></div>

            <div>
                <h2 class="mb-4"><?= l('index.privacy.header') ?></h2>

                <p class="text-muted"><?= l('index.privacy.subheader') ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-between mt-9">
        <div class="col-12 col-md-6 d-flex flex-column justify-content-center order-1 order-md-0">
            ...
            <div>
                ...
                <p class="text-muted"><?= l('index.session_recording.subheader') ?></p>
            </div>
        </div>
    ...
    <div class="row justify-content-between mt-9">
        ...
        <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
            ...
            <div>
                ...
                <p class="text-muted"><?= l('index.heatmaps.subheader') ?></p>
            </div>
        </div>
    </div>
    <?php endif ?>
    ...
    <div class="container">
        ...
        <div class="row mt-8">
            <div class="col-12 col-md-4 m mb-md-0">
                <?= (new \Altum\View('index/partials/testimonial'))->run([
                        'image' => l('index.testimonials.t1.image'),
                        'text' => l('index.testimonials.t1.text'),
                        'name' => l('index.testimonials.t1.name'),
                        'attribute' => l('index.testimonials.t1.attribute')]) ?>
            </div>

            <div class="col-12 col-md-4 m mb-md-0">
                <?= (new \Altum\View('index/partials/testimonial'))->run([
                    'image' => l('index.testimonials.t2.image'),
                    'text' => l('index.testimonials.t2.text'),
                    'name' => l('index.testimonials.t2.name'),
                    'attribute' => l('index.testimonials.t2.attribute')]) ?>
            </div>

            <div class="col-12 col-md-4 m mb-md-0">
                <?= (new \Altum\View('index/partials/testimonial'))->run([
                    'image' => l('index.testimonials.t3.image'),
                    'text' => l('index.testimonials.t3.text'),
                    'name' => l('index.testimonials.t3.name'),
                    'attribute' => l('index.testimonials.t3.attribute')]) ?>
            </div>
        </div>
    </div>
</div>
