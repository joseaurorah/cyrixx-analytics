...
<section class="container">
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            <li><a href="<?= url('visitors') ?>"><?= l('visitors.breadcrumb') ?></a> <i class="fa fa-fw fa-angle-right"></i></li>
    ...
    <div class="row">
        <div class="col-12 col-lg-3">
            ...
            <div class="row mt-3">
                <div class="col-5 col-lg-12">
                    <span class="text-muted"><?= l('visitor.visitor.country') ?></span>
                </div>
                <div class="col-7 col-lg-12">
                    <div>
            ...
            <div class="row mt-3">
                <div class="col-5 col-lg-12">
                    <span class="text-muted"><?= l('visitor.visitor.city') ?></span>
                </div>
                <div class="col-7 col-lg-12">
                    <div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-7 col-lg-12">
                    <div><i class="fa fa-fw fa-<?= $data->visitor->device_type ?> fa-sm mr-1"></i> <?= l('global.device.' . $data->visitor->device_type) ?></div>
                </div>
            </div>
            ...
            <div class="my-3">
                ...
                >
                    <i class="fa fa-fw fa-sm fa-trash-alt"></i> <?= l('global.delete') ?>
                </button>
            </div>
        </div>
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center justify-content-center py-3">
                            <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3" alt="<?= l('visitor.basic.no_data') ?>" />
                            <h2 class="h4 text-muted"><?= l('visitor.basic.no_data') ?></h2>
                        </div>
                    </div>
                </div>
            <?php else: ?>
                    ...
                    <div class="card border-0 mb-3">
                        <div class="card-body d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                            ...
                            <a href="#" class="mb-2 mb-md-0" data-toggle="modal" data-target="#session_events_modal" data-session-id="<?= $row->session_id ?>">
                                <i class="fa fa-fw fa-eye fa-sm text-muted"></i> <?= sprintf(l('visitor.basic.pageviews'), '<strong>' . nr($row->pageviews) . '</strong>') ?>
                            </a>

                            <?php if($row->sessions_replays_session_id): ?>
                                <a class="mb-2 mb-md-0" href="<?= url('replay/' . $row->sessions_replays_session_id) ?>">
                                    <i class="fa fa-fw fa-play-circle fa-sm text-muted"></i> <?= l('visitor.basic.replays') ?>
                                </a>
                            <?php endif ?>
