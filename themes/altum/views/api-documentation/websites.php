...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('api_documentation.websites.breadcrumb') ?></li>
        </ol>
    </nav>

    <h1 class="h4 mb-4"><?= l('api_documentation.websites.header') ?></h1>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= l('api_documentation.websites.scheme') ?></td>
                            </tr>
                            <tr>
                                <td>host</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><?= l('api_documentation.websites.tracking_type') ?></td>
                            </tr>
                            <tr>
                                <td>excluded_ips</td>
                                <td>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= l('api_documentation.websites.is_enabled') ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
