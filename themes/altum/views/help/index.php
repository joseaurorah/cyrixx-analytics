            ...
            <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                    <a href="<?= url('help') ?>" class="nav-link <?= $data->page == 'introduction' ? 'active' : null ?>">
                        <i class="fa fa-fw fa-sm fa-file mr-1"></i> <?= l('help.introduction.menu') ?>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="<?= url('help/setup') ?>" class="nav-link <?= $data->page == 'setup' ? 'active' : null ?>">
                        <i class="fa fa-fw fa-sm fa-plus-circle mr-1"></i> <?= l('help.setup.menu') ?>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="<?= url('help/install') ?>" class="nav-link <?= $data->page == 'install' ? 'active' : null ?>">
                        <i class="fa fa-fw fa-sm fa-code mr-1"></i> <?= l('help.install.menu') ?>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="<?= url('help/lightweight-tracking') ?>" class="nav-link <?= $data->page == 'lightweight_tracking' ? 'active' : null ?>">
                        <i class="fa fa-fw fa-sm fa-chart-bar mr-1"></i> <?= l('help.lightweight_tracking.menu') ?>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="<?= url('help/advanced-tracking') ?>" class="nav-link <?= $data->page == 'advanced_tracking' ? 'active' : null ?>">
                        <i class="fa fa-fw fa-sm fa-eye mr-1"></i> <?= l('help.advanced_tracking.menu') ?>
                    </a>
                </li>
            </ul>
        </div>
