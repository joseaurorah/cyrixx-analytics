...
<nav class="navbar navbar-main <?= \Altum\Router::$controller_settings['menu_no_margin'] ? null : 'mb-8'?> navbar-expand-lg navbar-light bg-white">
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="main_navbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="<?= url('#pricing') ?>"> <?= l('global.menu.pricing') ?></a></li>

                <li class="nav-item"><a class="nav-link" href="<?= url('help') ?>"> <?= l('help.menu') ?></a></li>
