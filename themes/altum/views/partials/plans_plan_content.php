...
<ul class="pricing-feature-list">
    ...
    <?php if(settings()->analytics->domains_is_enabled): ?>
        <li class="pricing-feature d-flex align-items-baseline mb-2">
            <i class="fa fa-fw fa-sm mr-3 <?= !$data->plan_settings->domains_limit ? 'fa-times-circle text-muted' : 'fa-check-circle text-success' ?>"></i>
            <div>
    ...
    <?php if(\Altum\Plugin::is_active('affiliate') && settings()->affiliate->is_enabled): ?>
        <li class="pricing-feature d-flex align-items-baseline mb-2">
            <i class="fa fa-fw fa-sm mr-3 <?= !$data->plan_settings->affiliate_commission_percentage ? 'fa-times-circle text-muted' : 'fa-check-circle text-success' ?>"></i>
            <div>
