                ...
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        <?php if($row->referrer_host): ?>
                            ...
                            <a href="#" data-target="#referrer_paths_modal" data-toggle="modal" data-referrer-host="<?= $row->referrer_host ?>" title="<?= $row->referrer_host ?>" class="align-middle"><?= $row->referrer_host ?></a>
                        ...
                        <?php else: ?>
                            <span title="<?= l('dashboard.referrers.null') ?>" class="align-middle"><?= l('dashboard.referrers.null') ?></span>
                        <?php endif ?>
                    </div>
