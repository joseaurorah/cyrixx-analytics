...
<div class="altum-animate altum-animate-fill-none altum-animate-fade-in">
    <div class="d-flex justify-content-between mb-2">
        <small class="text-muted font-weight-bold text-uppercase"><?= l('dashboard.utms.utm') ?></small>
    ...
    <?php else: ?>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        <a href="#" data-target="#utms_medium_campaign_modal" data-toggle="modal" data-utm-source="<?= $row->utm ?>" class="align-middle"><?= $row->utm ?></a>
                    </div>
        ...
        <?php if($data->total_rows > count($data->rows)): ?>
            <a href="<?= url('dashboard/utms') ?>"><?= sprintf(l('global.view_x_more'), nr($data->total_rows - count($data->rows))) ?></a>
        <?php endif ?>
