...
<header class="header">
    <div class="container">
        ...
        <?php if($data->type != 'default'): ?>
            <nav aria-label="breadcrumb">
                <ol class="custom-breadcrumbs small">
                    <li><a href="<?= url('dashboard') ?>"><?= l('dashboard.breadcrumb') ?></a> <i class="fa fa-fw fa-angle-right"></i></li>
        ...
        <div class="d-flex flex-column flex-xl-row justify-content-between mb-3">
            ...
            <div>
                <span data-toggle="tooltip" title="<?= l('global.reset') ?>">
                    <button
                            type="button"
                ...
                <?php if($this->website->tracking_type == 'normal'): ?>
                    <button type="button" class="btn btn-sm btn-outline-secondary d-print-none my-1" onclick="window.open('<?= url('dashboard/csv_normal') ?>')" data-toggle="tooltip" title="<?= sprintf(l('global.export_to'), 'CSV') ?>">
                        <i class="fa fa-fw fa-file-csv"></i>
                    </button>
                <?php endif ?>

                <?php if($this->website->tracking_type == 'lightweight'): ?>
                    <button type="button" class="btn btn-sm btn-outline-secondary d-print-none my-1" onclick="window.open('<?= url('dashboard/csv_lightweight') ?>')" data-toggle="tooltip" title="<?= sprintf(l('global.export_to'), 'CSV') ?>">
                        <i class="fa fa-fw fa-file-csv"></i>
                    </button>
                <?php endif ?>

                <button type="button" class="btn btn-sm btn-outline-secondary d-print-none my-1" onclick="window.print()" data-toggle="tooltip" title="<?= sprintf(l('global.export_to'), 'PDF') ?>">
        ...
        <div class="card border-0">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center py-3">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3" alt="<?= l('dashboard.basic.no_data') ?>" />
                    <h2 class="h4 text-muted"><?= l('dashboard.basic.no_data') ?></h2>
                    <p class="text-muted"><?= sprintf(l('dashboard.basic.no_data_help'), '<a href="' . url('websites') . '">', '</a>') ?></a></p>
                </div>
            </div>
        </div>
    <?php else: ?>
