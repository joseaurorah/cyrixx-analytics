    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><?= l('goal_create_modal.header') ?></h5>
                ...
                <form name="goal_create" method="post" role="form">
                    ...
                    <div class="form-group">
                        <select name="type" class="form-control form-control-lg">
                            <option value="pageview"><?= l('goal_create_modal.input.type_pageview') ?></option>
                            <option value="custom"><?= l('goal_create_modal.input.type_custom') ?></option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label><i class="fa fa-fw fa-sm fa-signature text-gray-700 mr-1"></i> <?= l('goal_create_modal.input.name') ?></label>
                    ...
                    <div class="d-none" id="goal_create_type_pageview">
                        ...
                        <div class="form-group">
                            <label><i class="fa fa-fw fa-sm fa-link text-gray-700 mr-1"></i> <?= l('goal_create_modal.input.path') ?></label>
                            <div class="input-group">
                                <div id="path_prepend" class="input-group-prepend">
                                    <span class="input-group-text"><?= $this->website->host . $this->website->path . '/' ?></span>
                                </div>

                                <input type="text" name="path" class="form-control form-control-lg" placeholder="<?= l('goal_create_modal.input.path_placeholder') ?>" />
                            </div>
                        </div>
                    ...
                    <div class="d-none" id="goal_create_type_custom">
                        ...
                        <div class="form-group">
                            <label><i class="fa fa-fw fa-sm fa-fingerprint text-gray-700 mr-1"></i> <?= l('goal_create_modal.input.key') ?></label>
                            <input type="text" class="form-control form-control-lg" name="key" value="<?= get_slug(string_generate(16)) ?>" placeholder="<?= l('goal_create_modal.input.key_placeholder') ?>" />
                        </div>

                        <div class="form-group">
                            <label><i class="fa fa-fw fa-sm fa-code text-gray-700 mr-1"></i> <?= l('goal_create_modal.input.code') ?></label>
                            <input type="text" class="form-control form-control-lg" name="code" value="" readonly="readonly" />
                            <small class="form-text text-muted"><?= l('goal_create_modal.input.code_help') ?></small>
                        </div>
