            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/paths') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/referrers') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
    ...
    <div class="col-12 col-lg-6 col-xl-4 mb-4 mb-md-5">
        <div class="card border-0 h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        <h2 class="h5 m-0"><?= l('dashboard.countries.header') ?></h2>

                        <a href="<?= url('dashboard/countries') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/operating-systems') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/device_types') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/browser-names') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/utms') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/screen-resolutions') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex">
                        ...
                        <a href="<?= url('dashboard/browser-languages') ?>" class="text-muted ml-3" data-toggle="tooltip" title="<?= l('global.view_more') ?>"><i class="align-self-end fa fa-arrows-alt-h text-gray"></i></a>
                    </div>
                    <span class="round-circle-sm bg-gray-200 text-primary-700 p-3">
