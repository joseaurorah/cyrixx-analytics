    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                <li><a href="<?= url('heatmaps') ?>"><?= l('heatmaps.breadcrumb') ?></a> <i class="fa fa-fw fa-angle-right"></i></li>
            ...
            <div class="mb-3 mb-md-0">
                <div class="d-flex align-items-baseline">
                    ...
                    <div class="dropdown ml-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="#" data-toggle="modal" data-target="#heatmap_update" data-heatmap-id="<?= $data->heatmap->heatmap_id ?>" data-name="<?= $data->heatmap->name ?>" data-is-enabled="<?= $data->heatmap->is_enabled ?>" class="dropdown-item"><i class="fa fa-fw fa-sm fa-pencil-alt mr-2"></i> <?= l('global.update') ?></a>
                            <a href="#" data-toggle="modal" data-target="#heatmap_retake_snapshots" data-heatmap-id="<?= $data->heatmap->heatmap_id ?>" class="dropdown-item"><i class="fa fa-fw fa-sm fa-camera mr-2"></i> <?= l('heatmaps.heatmap.retake_snapshots') ?></a>
                            <a href="#" data-toggle="modal" data-target="#heatmap_delete" data-heatmap-id="<?= $data->heatmap->heatmap_id ?>" class="dropdown-item"><i class="fa fa-fw fa-sm fa-trash-alt mr-2"></i> <?= l('global.delete') ?></a>
                        </div>
                    </div>
                    <?php endif ?>
                </div>
                <div>
                    <?php if($data->heatmap->is_enabled): ?>
                        <span class="badge badge-success"><i class="fa fa-fw fa-check"></i> <?= l('heatmaps.heatmap.is_enabled_true') ?></span>
                    <?php else: ?>
                        <span class="badge badge-warning"><i class="fa fa-fw fa-eye-slash"></i> <?= l('heatmaps.heatmap.is_enabled_false') ?></span>
                    <?php endif ?>
            ...
            <div>
                <div class="btn-group" role="group">
                    <a href="<?= url('heatmap/' . $data->heatmap->heatmap_id . '/desktop') ?>" class="btn btn-sm <?= $data->snapshot_type == 'desktop' ? 'btn-primary' : 'btn-secondary' ?>">
                        <i class="fa fa-fw fa-desktop"></i> <?= $data->snapshot_type == 'desktop' ? sprintf(l('heatmap.click'), '<span id="heatmap_data_count"></span>') : null ?>
                    </a>
                    <a href="<?= url('heatmap/' . $data->heatmap->heatmap_id . '/tablet') ?>" class="btn btn-sm <?= $data->snapshot_type == 'tablet' ? 'btn-primary' : 'btn-secondary' ?>">
                        <i class="fa fa-fw fa-tablet"></i> <?= $data->snapshot_type == 'tablet' ? sprintf(l('heatmap.click'), '<span id="heatmap_data_count"></span>') : null ?>
                    </a>
                    <a href="<?= url('heatmap/' . $data->heatmap->heatmap_id . '/mobile') ?>" class="btn btn-sm <?= $data->snapshot_type == 'mobile' ? 'btn-primary' : 'btn-secondary' ?>">
                        <i class="fa fa-fw fa-mobile"></i> <?= $data->snapshot_type == 'mobile' ? sprintf(l('heatmap.click'), '<span id="heatmap_data_count"></span>') : null ?>
                    </a>
                </div>
            </div>
        </div>
