...
<div>
    <div class="form-group">
        <label for="key"><?= l('admin_settings.support.key') ?></label>
        <input id="key" name="key" type="text" class="form-control form-control-lg disabled" value="<?= settings()->support->key ?? '-' ?>" readonly="readonly" />
    </div>
    ...
    ?>
        ...
        <?php if(!$is_active): ?>
            <a href="https://altumco.de/extend-support-<?= settings()->license->type ?>" target="_blank" class="btn btn-block btn-success mb-3"><?= l('admin_settings.support.extend') ?></a>
        <?php endif ?>
    <?php else: ?>
        <a href="https://altumco.de/extend-support-<?= settings()->license->type ?>" target="_blank" class="btn btn-block btn-success mb-3"><?= l('admin_settings.support.extend') ?></a>
    <?php endif ?>
    ...
    <div class="form-group">
        <label for="new_key"><?= l('admin_settings.support.new_key') ?></label>
        <input id="new_key" name="new_key" type="text" class="form-control form-control-lg" required="required" />
