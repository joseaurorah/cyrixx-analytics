...
if(isset(settings()->support->expiry_datetime)):
    ...
    <div class="alert alert-warning">
        ...
        <?= sprintf(l('admin_index.support.inactive'), '<a href="https://altumco.de/extend-support-' . settings()->license->type . '" target="_blank" class="font-weight-bold">', '</a>') ?>
...
<div class="mb-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-server mr-1"></i> <?= l('admin_websites.menu') ?></small>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-user-shield mr-1"></i> <?= l('admin_index.teams') ?></small>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-fire mr-1"></i> <?= l('admin_index.heatmaps') ?></small>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-bullseye mr-1"></i> <?= l('admin_index.goals') ?></small>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-envelope mr-1"></i> <?= l('admin_index.email_reports') ?></small>
