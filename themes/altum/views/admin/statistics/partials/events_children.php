...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-bell fa-xs text-muted"></i> <?= l('admin_statistics.events_children.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['click']) ?></span> <?= l('admin_statistics.events_children.chart_click') ?>
            </div>
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['form']) ?></span> <?= l('admin_statistics.events_children.chart_form') ?>
            </div>
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['scroll']) ?></span> <?= l('admin_statistics.events_children.chart_scroll') ?>
            </div>
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['resize']) ?></span> <?= l('admin_statistics.events_children.chart_resize') ?>
            </div>
        </div>
