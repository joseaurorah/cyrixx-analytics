            ...
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <?php if(in_array(settings()->license->type, ['Extended License','extended'])): ?>
                        ...
                        <?php endif ?>
                    <?php endif ?>
                    <a class="nav-link <?= $data->type == 'websites' ? 'active' : null ?>" href="<?= url('admin/statistics/websites?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-server mr-1"></i> <?= l('admin_statistics.websites.menu') ?></a>
                    ...
                    <a class="nav-link <?= $data->type == 'lightweight_events' ? 'active' : null ?>" href="<?= url('admin/statistics/lightweight_events?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-seedling mr-1"></i> <?= l('admin_statistics.lightweight_events.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'sessions_events' ? 'active' : null ?>" href="<?= url('admin/statistics/sessions_events?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-seedling mr-1"></i> <?= l('admin_statistics.sessions_events.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'events_children' ? 'active' : null ?>" href="<?= url('admin/statistics/events_children?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-bell mr-1"></i> <?= l('admin_statistics.events_children.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'sessions_replays' ? 'active' : null ?>" href="<?= url('admin/statistics/sessions_replays?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-video mr-1"></i> <?= l('admin_statistics.sessions_replays.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'websites_heatmaps' ? 'active' : null ?>" href="<?= url('admin/statistics/websites_heatmaps?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-fire mr-1"></i> <?= l('admin_statistics.websites_heatmaps.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'websites_goals' ? 'active' : null ?>" href="<?= url('admin/statistics/websites_goals?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-bullseye mr-1"></i> <?= l('admin_statistics.websites_goals.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'goals_conversions' ? 'active' : null ?>" href="<?= url('admin/statistics/goals_conversions?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-bullseye mr-1"></i> <?= l('admin_statistics.goals_conversions.menu') ?></a>
                    ...
                    <a class="nav-link <?= $data->type == 'email_reports' ? 'active' : null ?>" href="<?= url('admin/statistics/email_reports?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-envelope mr-1"></i> <?= l('admin_statistics.email_reports.menu') ?></a>
                </div>
            </div>
        </div>
    </div>
