    ...
    class MutationBuffer {
        constructor() {
            ...
            this.emit = () => {
                ...
                const pushAdd = (n) => {
                    var _a2, _b, _c, _d, _e;
                    const shadowHost = n.getRootNode ? (_a2 = n.getRootNode()) == null ? void 0 : _a2.host : null;
                        ...
                        for (let index = addList.length - 1; index >= 0; index--) {
                            ...
                            if (_node) {
                                ...
                                if (nextId === -1)
                                    ...
                                    const shadowHost = nodeInShadowDom.getRootNode ? (_a = nodeInShadowDom.getRootNode()) == null ? void 0 : _a.host : null;
    ...
    class Replayer {
        constructor(events, config) {
            ...
            this.handleResize = (dimension) => {
                ...
                this.iframe.setAttribute('data-width', dimension.width);
                this.iframe.setAttribute('style', `width: ${dimension.width}px;pointer-events: none; position: absolute; top: 0; left: 0;`);
